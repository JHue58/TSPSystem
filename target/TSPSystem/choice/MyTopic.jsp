...
课题来源：<br/>
<input type="radio" name="source" disabled value="A" ${topic.source eq "A"?"checked":""}>自然（社会）科学基金与省（部）、市级以上科研课题<br/>
...
<form action="DropMyTopic" method="post">
    <input type="text" hidden value="${topic.id}" name="id">
    <input type="submit" value="退选" onclick="return confirm('确认退选？')">
</form>
</body>
</html>
